...
| 版本 | 内容 | 文件夹 |
|---|---|---|
| v0.1 | 纯文字矢量 PDF：段落合并、粗体、腾讯翻译、基线对齐 | `v0.1/` |
| v0.2 | v0.1 + 深色矢量块 / 图片背景保留（不挖白洞） | `v0.2/` |
| v0.3 | v0.2 + 翻译缓存、编号前缀保留、缩写识别、qwen 本地引擎 | `v0.3/` |
| v0.4 | v0.3 + 上下标正确渲染、DocLayout-YOLO 真正接入段落合并 | `v0.4/` |
| v0.5 | v0.4 + LaTeX 公式解析渲染、中文空格清理、公式渲染开关 | `v0.5/` |
| v0.5.1 | v0.5 + 段落合并修复、排序修复、文本框宽度修复 | `v0.5/` (demo_v0.5.1.py) |
| v0.5.1.1 | v0.5.1 + CMSY 字体字符 → Unicode 符号映射（Σ Π ∫） | `v0.5/` (demo_v0.5.1.1.py) |
| v0.5.3 | v0.5 + 图片级平移尝试、Formula 模型调研 | `v0.5.3/` |
| v0.5.4 | v0.5.3 + 分块翻译、qwen 公式保留 | `v0.5.4/` |
| v0.5.5 | v0.5.4 + LaTeX 排版引擎矢量渲染（matplotlib mathtext → PDF） | `v0.5.5/` |
| v0.5.6 | v0.5.5 + CMSY 字体→LaTeX 映射 + 求和符号上下标组合 | `v0.5.6/` |
| v0.5.7 | v0.5.6 + qwen2.5vl 公式截图识别尝试 | `v0.5.7/` |
